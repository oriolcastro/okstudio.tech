module.exports = {
  ...
  siteDescription:
    "Espai web d'Ok studio, una petita agencia de desenvolupament web ubicada a Vilanova i la geltrú", // Website description used for RSS feeds/meta description tag.
